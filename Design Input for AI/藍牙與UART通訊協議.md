...
校驗和計算: 
(0x01 + 0x0C + 0x07 + 0xE9 + 0x00 + 0x03 + 0x00 + 0x07 + 0x00 + 0x0F + 0x00 + 0x20 + 0x00 + 0x3B) % 256
= (1 + 12 + 7 + 233 + 0 + 3 + 0 + 7 + 0 + 15 + 0 + 32 + 0 + 59) % 256
= 369 % 256
= 113
= 0x71

完整封包: [0xAA, 0x01, 0x0C, 0x07, 0xE9, 0x00, 0x03, 0x00, 0x07, 0x00, 0x0F, 0x00, 0x20, 0x00, 0x3B, 0x71, 0x55]
```
...
2. **同步時間**
   ...
   **【資料例】**:
   ```
   APP發送: 
   [0xAA, 0x01, 0x0C, 0x07, 0xE9, 0x00, 0x03, 0x00, 0x07, 0x00, 0x0F, 0x00, 0x20, 0x00, 0x3B, 0x71, 0x55]
...
| OPERATOR ID | 10 | 操作者ID (ASCII碼) | A123456789 |

...
校驗和計算: (0x01 + 0x07 + 0x07 + 0xE9 + 0x03 + 0x07 + 0x0F + 0x20 + 0x3B) % 256
         = (0x01 + 0x07 + 0x07 + 0xE9 + 0x03 + 0x07 + 0x0F + 0x20 + 0x3B) % 256
         = 0x16C % 256
         = 0x6C

完整封包: [0xAA, 0x01, 0x07, 0x07, 0xE9, 0x03, 0x07, 0x0F, 0x20, 0x3B, 0x6C, 0x55]
```
...
2. **同步時間**
   ...
   **【資料例】**:
   ```
   APP發送: 
   [0xAA, 0x01, 0x07, 0x07, 0xE9, 0x03, 0x07, 0x0F, 0x20, 0x3B, 0x6C, 0x55]
...
4. **設定測試參數**
   ...
   **【資料例】**:
   ...
   [0xAA, 0x03, 0x03, 0x19, 0x00, 0x01, 0x20, 0x55]
...
傳輸中發生錯誤，Meter收到的封包:
[0xAA, 0x01, 0x07, 0x07, 0xE9, 0x03, 0x17, 0x0F, 0x20, 0x3B, 0x6C, 0x55]
(日期值被錯誤地修改為0x17)

Meter重新計算校驗和:
(0x01 + 0x07 + 0x07 + 0xE9 + 0x03 + 0x17 + 0x0F + 0x20 + 0x3B) % 256 = 0x7C

計算結果(0x7C)與收到的校驗和(0x6C)不匹配，返回錯誤:
